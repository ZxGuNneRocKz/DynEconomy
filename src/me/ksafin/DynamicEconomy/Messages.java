...
public class Messages
{
	...
	public static String buyDisabled;
	public static String sellDisabled;
	public static String buyEnchantmentDisabled;
	public static String sellEnchantmentDisabled;
	...
	public static void getMessages()
	{
		...
		invalidCommandArgs = config.getString("invalid-command-args",
		...
		bannedItem = config.getString("banned-item",
				"&2This item is banned, and not allowed to be purchased in the economy.");
		...
		loanAccountNotFound = config.getString("loan-account-not-found",
				"&2The Bank is not available, contact your server admin");
		buyDisabled = config.getString("buy-disabled", "&2Please use a &fDynamicShop&2 to buy items.");
		sellDisabled = config.getString("sell-disabled", "&2Please use a &fDynamicShop&2 to sell items.");
		buyEnchantmentDisabled = config
				.getString("buy-enchant-disabled", "&2Please us a &fDynamicShop to buy Enchantments.");
		sellEnchantmentDisabled = config.getString("sell-enchant-disabled",
				"&2Please us a &fDynamicShop to sell Enchantments.");
	}
}
